...
parser.add_argument('--s-metric', type=str, default='val_subject_precision_{}:')
parser.add_argument('--o-metric', type=str, default='val_object_precision_{}:')
...
for model_idx in next(os.walk(directory))[1]:
    try:
        ...
        params = json.load(open(os.path.join(directory, model_idx,"args.json")))
    except IOError:
        print(model_idx)
        continue
