...
#parser.add_argument('--use-predicate', type=int, default=1, help='1/0 indicating whether to use the predicates.')
...
for _ in range(args.nruns):
    params = {
        ...
        'patience': np.random.choice([2, 3, 5]),
        ...
        'conv-im-kernel': np.random.choice([1, 2, 3]),
    ...
    train += ' --models-dir ' + args.models_dir + ' --save-best-only --train-data-dir ' + args.train_data_dir + ' --val-data-dir ' + args.val_data_dir + ' --test-data-dir ' + args.test_data_dir
