...
class PredicateIterator(Sequence):
    """Predicate iterator that corresponds to `data.PredicateDataset`.
    """
    ...
    def __init__(self, data_dir, args):
        ...
        for j in group_names:
            ...
            predicate_samples = categories.shape[0]
            self.samples += predicate_samples
            batches = math.ceil(float(predicate_samples) /  self.batch_size)
