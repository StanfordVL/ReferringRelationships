...
class RefRelDataIterator(Iterator):
    ...
    def next(self):
        ...
        for i, j in enumerate(index_array):
            ...
            try:
                img = load_img(os.path.join(self.image_dir, image_fname + ".jpg"), grayscale=False, target_size=self.target_size)
            except IOError:
                img = load_img(os.path.join(self.image_dir, image_fname + ".png"), grayscale=False, target_size=self.target_size)
